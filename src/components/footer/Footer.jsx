    ...
    return (
        <div id='footer' className=' text-white'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#0F172A" fill-opacity="1" d="M0,160L48,144C96,128,192,96,288,96C384,96,480,128,576,149.3C672,171,768,181,864,197.3C960,213,1056,235,1152,224C1248,213,1344,171,1392,149.3L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
            </svg>
            <div className='bg-slate-900 px-20 pb-20 flex flex-col justify-center items-center gap-5'>
                <div>
                    Winky
                </div>
                <div className='flex gap-5'>
                    <a href="https://www.facebook.com/threalwinky/">
                        ...
                        <svg
                            ...
                            height="2.5em"
                            width="2.5em"
                            className='text-white border-2 rounded-full border-white p-1
                            cursor-pointer
                            hover:bg-white
                            transition-[0.5s]
                            '
                ...
                <div>
                    <p>© 2024 Winky. All rights reserved.</p>
                </div>
            </div>
        </div>
    )
