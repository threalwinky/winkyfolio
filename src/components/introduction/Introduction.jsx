        ...
        <div id='introduction'>
            ...
            <div className='flex xl:h-screen flex-row-reverse w-full items-center justify-center gap-20 max-md:flex-col pt-56 pb-40 px-32 max-md:px-10 max-md:pt-40 font-jm'>
                <motion.img
                    ...
                    className='home-img rounded-full max-w-[26rem] max-md:max-w-[20rem] w-full ' src={Myself} alt="Myself" />
                <div className='w-fit flex flex-col gap-5'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <h1 className='text-white text-3xl h-[2rem] max-xl:h-full'>
                        <TypeAnimation
                            sequence={[
                                
                                1000, // Waits 1s
                                'This is Quang Vu a.k.a winky', // Types 'One'
                                2000, // Waits 1s
                        ...
                        <h1 className='text-white text-2xl h-12'>
                        <TypeAnimation
                            sequence={[
                    ...
                    <ul>
                        <motion.li
                            ...
                            className='text-gray-400 list-disc max-w-[45rem]'>
                            I am an introverted yet versatile individual,
                            always eager to tackle new challenges. Fueled
                            by a passion for learning, I am dedicated to
                        ...
                        <motion.li
                            ...
                            and mindset make me ready to contribute meaningfully and achieve great things.
                        </motion.li>
                        ...
                        <motion.li
                            ...
                            className='text-gray-400 list-disc max-w-[45rem]'>
                            With 3 years of programming experience, I'm confident in my ability to tackle your projects. Don't hesitate to book me!
                    ...
                    <div className='flex gap-5'>
                        <motion.a
                            ...
                            href="https://www.facebook.com/threalwinky/">
                        ...
                        <motion.a
                            ...
                            href="https://github.com/threalwinky">
                            <svg
                                data-name="Layer 1"
                                viewBox="0 0 24 24"
                                fill="currentColor"
                        ...
                        <motion.a
                            ...
                            href="https://www.instagram.com/threalwinky/">
                        ...
                        <motion.a
                            ...
                            href="https://www.linkedin.com/in/threalwinky/">
                    ...
                    <div><a href="#about">
                        <motion.button
                         ...
                         hover:bg-blue-500 rounded-xl px-10 mt-5'>
                            Read more !
                        </motion.button>
                    </a>
